...
ServiceEvent SE= new ServiceEvent();
  ...
  /*  public void setReservation(Reservation r) {
    ...
    @FXML
    private void submit() throws  IOException, WriterException, ChecksumException, NotFoundException, FormatException {
int nbplace = nbPlace.getValue();
        ...
        Reservation r= new Reservation();
        r.setId_participant(loggedInUser.getUser());
        r.setId_event(e);
        ...
        if (e != null) {
            ...
            email.sendEmail(loggedInUser.getUser().getEmail(), subject, message_content);
            email.sendReminderEmail(e,loggedInUser.getUser());
